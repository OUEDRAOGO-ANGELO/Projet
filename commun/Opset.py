...
class Opset:
    ...
    def __init__(self, storename, Nomfichier, phase=None, pos=0, name=None, sortkey=None):
        ...
        #def create_List_Vol(self):
            ...
            #list_nom = [f"Vol {i+1}" for i in range(len(store.keys()))]
            #return list_nom

        
        self.Nomfichier=Nomfichier  ## Perso
